...
<meta name="description" content="EzOnset is the Pakistan's largest freelance services marketplace for lean entrepreneurs to focus on growth & create a successful business at affordable costs.">
...
<a class="nav-link active" data-toggle="pill" href="#terms-conditions">
...
<a class="nav-link" data-toggle="pill" href="#refund-policy">
...
<a class="nav-link" data-toggle="pill" href="#pricing-promotions-policy">
...
<div id="terms-conditions" class="tab-pane fade show active"><!--- tab-pane fade show active Starts -->
...
<div id="refund-policy" class="tab-pane fade"><!--- tab-pane fade Starts -->
...
<div id="pricing-promotions-policy" class="tab-pane fade"><!--- tab-pane fade Starts -->

<h1>Pricing And Promotions Policy</h1>
